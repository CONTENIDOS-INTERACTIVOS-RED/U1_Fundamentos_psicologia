        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 La unidad 1 del curso "Fundamentos de psicología", analiza el desarrollo histórico y teórico de la psicología como ciencia. Recorre desde los orígenes filosóficos con Aristóteles y Descartes, pasando por el psicoanálisis de Freud, el conductismo de Watson y Skinner, hasta la psicología humanista de Maslow y Rogers. Se incluyen avances modernos como el cognitivismo, la psicología positiva y la neurociencia. Se destacan las principales escuelas psicológicas y sus enfoques epistemológicos, enfatizando su relevancia actual en ámbitos como la salud mental, educación y desarrollo personal.
